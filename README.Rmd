...
What if you wanted to combine the best of both approaches? A loosely defined project with a just strict-enough versioning requirement. All this without having to write a `DESCRIPTION` file. Why would you need a `DESCRIPTION` when you have no package and it won't let you pin an exact the package version or to specify alternate CRAN-like repositories?
