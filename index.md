...
Once you decorated your code, you can call
[`deps::create()`](https://hub.analythium.io/deps/reference/create.md)
to write your `dependencies.json` file.

Use
[`deps::install()`](https://hub.analythium.io/deps/reference/install.md)
to install dependencies based on scanning a project folder or using and
existing `dependencies.json` file.
...
The packages list found by
[`renv::dependencies()`](https://rstudio.github.io/renv/reference/dependencies.html)
is refined and modified by ‘roxygen’-style comments. But the packages
need to be declared/used somewhere in the source code for the comments
to take effect.
...
The [`create()`](https://hub.analythium.io/deps/reference/create.md)
function will crawl the project directory for package dependencies. It
will amend the dependency list and package sources based on the
comments. The summary is written into the `dependencies.json` file.
Optionally, the system requirements are written into the
`dependencies.json` file as well.

[`install()`](https://hub.analythium.io/deps/reference/install.md) will
look for the `dependencies.json` file in the root of the project
directory and perform dependency installation if the file exists. If the
file does not exist, it uses
[`create()`](https://hub.analythium.io/deps/reference/create.md) to
create that file before attempting installation but removes the
`dependencies.json` file afterwards, leaving no trace.

## deps-cli

A CLI example is given in
[`inst/examples/03-cli`](https://hub.analythium.io/deps/inst/examples/03-cli/):
...
See the [`inst/examples`](https://hub.analythium.io/deps/inst/examples/)
...
The [`create()`](https://hub.analythium.io/deps/reference/create.md)
function prompts the user asking confirmation before writing the
`dependencies.json` file. Use `create(ask = FALSE)` to bypass the
prompt.

## License

[MIT License](https://hub.analythium.io/deps/LICENSE) © 2022-2023 Peter
