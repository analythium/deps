...
rversions <- function() {
    ...
    "4.3.2"), date = structure(c(881225278, 882709762, 884392315, 889903555, 
    ...
    1682060774, 1686899167, 1698739662), class = c("POSIXct", "POSIXt"), tzone = "UTC")),
    class = "data.frame", row.names = c(NA, -133L))
}
